...
export const useGameStore = defineStore('game', () => {
  ...
  // Триггер появления предметов — App.vue пишет, InitializeGame читает
  ...
  function setLoadTime(t: number)     { loadTime.value  = t }
  ...
  return {
    ...
    spawnTrigger,
    updateRoom, setProgress, setLoading, setLoadTime, setCharacter,
    triggerSpawn,
  }
})